package com.yss.gateway.controller;

import com.alibaba.fastjson.JSON;
import com.yss.gateway.entity.City;
import com.yss.gateway.service.RedisService;
...
public class CityController {
    ...
    public City getCity(int cityId){
        City city = JSON.parseObject(redisService.get(cityId+"").toString(),City.class);
        return city;
    }
}
